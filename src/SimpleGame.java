...
public class SimpleGame {
    ...
    public String convertTime(int seconds){
        ...
        int secondsA = (seconds%3600)%60;
        String answer = hours+":"+minutes+":"+secondsA;
        return answer;
    }
    ...
    public int digitsSum(int input){
        ...
        if (input%10 == input){
            ...
            return input%10 + digitsSum(((input - (input% 10))) / 10);
        }
    }
    ...
    public static void main(String[] args) {
        ...
        // TODO: Your code goes here
        SimpleGame gameOne = new SimpleGame();

        Scanner sc = new Scanner(System.in);

        // Ask the user which game to play.
        System.out.println("Which game do you want to play? 1 or 2: ");
        ...
        if (gameType == 1){
            System.out.println("Enter the number of seconds and we will convert it into hours and minutes: ");
            int numberTime = sc.nextInt();
            String converted = gameOne.convertTime(numberTime);
            System.out.println("The converted seconds are - "+ converted);
        }
        // If the user enters 2, ask for an integer and call the digitsSum method.
        if (gameType == 2){
            System.out.println("Enter the number so we can calculate the number of digits: ");
            int numberSum = sc.nextInt();
            int calculated = gameOne.digitsSum(numberSum);
            System.out.println("The calculated sum is: "+ calculated);
        }
